...
# Managing OpenEnsemble Dashboards 

In the getting started workflow there is the opportunity [to select and install](https://www.fathym.com/openensemble/docs/getting-started/devices) default data dashboard services. These dashboard services provide an accessible, in-platform way to view and explore device data.

There are currently two dashboard services, one required and one optional:

- **Azure Data Explorer (required):** [Azure Data Explorer](https://azure.microsoft.com/en-us/products/data-explorer) is an analytics service for real-time and time-series analysis on large volumes of data streams. Use it to quickly identify patterns, anomalies and trends in your data. Azure Data Explorer’s primary purpose is to power OpenEnsemble’s turnkey [Device Data Dashboard](https://www.fathym.com/openensemble/docs/platform/dashboard/device-data-dashboard) (this is why its installation is required), but you can also access and use Azure Data Explorer directly within the platform. 
...
To access and manage these dashboard services from the OpenEnsemble platform, view the sidebar to the left. 
...
![OpenEnsemble Azure Data Explorer](https://www.fathym.com/iot/img/screenshots/biotech-azure-data-explorer.png)
...
![OpenEnsemble Create New Dashboard](https://www.fathym.com/iot/img/screenshots/biotech-create-new-dashboard.png)
...
![OpenEnsemble Create New Dashboard Dropdown](https://www.fathym.com/iot/img/screenshots/biotech-create-dashboard-dropdown-selection.png)
